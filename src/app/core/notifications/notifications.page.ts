...
export class NotificationsPage implements OnInit {
  ...
  ionViewWillEnter() {
    ...
    this.loading = this.loadingController.create({
      ...
      this.get.getNotification(this.page).subscribe(res => {
        this.response = res;
  ...
  getAllNotification(page) {
    this.get.getNotification(page).subscribe(res => {
      this.response = res;
  ...
  readNotification(id: number, idTask: number, actionVerb: string) {
    this.loading = this.loadingController.create({
      ...
      this.post.readNotification(id, 'notification').subscribe(res => {
        let resp: any = res;
        this.data = resp['data'];
        // console.log(id,idTask,actionVerb);

        this.dataListPagination = [];
        this.get.getNotification(this.page).subscribe(info => {
          this.response = info;
  ...
  readAll() {
    this.loading = this.loadingController.create({
      ...
      this.post.readAllNotification('read all notifications').subscribe(res => {
        let resp: any = res;
        this.data = resp['data'];
