...
export class AddressPage implements OnInit {
  ...
  ionViewWillEnter() {
    ...
    this.loadingController.create({
      ...
      loading.present();
      this.addressService.getAddressId(this.addressId).subscribe(res => {
        this.data = res["data"];
        ...
        this.addressService.getCountries().subscribe((res) => {
          ...
          this.addressService.getStates(this.codeCountry).subscribe((sta) => {
            ...
            this.addressService.getCities(this.stateId).subscribe(cit => {
  ...
  edit(address) {
    this.loadingController.create({
      ...
      this.addressService.editAddressId(this.addressId, address.value).subscribe(res => {
        loading.dismiss();
