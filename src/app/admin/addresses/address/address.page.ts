...
export class AddressPage implements OnInit {
  ...
  ionViewWillEnter() {
    ...
    this.loadingController.create({
      ...
      .then(loading => {
        loading.present();
        this.adminServices.getAddressId(this.addressId).subscribe(
          res => {
            this.data = res["data"];
            ...
            this.adminServices.getCountries().subscribe((res) => {
              ...
              this.adminServices.getStates(this.codeCountry).subscribe((sta) => {
                ...
                this.adminServices.getCities(this.stateId).subscribe(cit => {
  ...
  changeStates(ev) {
    ...
    this.loadingController.create({
      ...
      this.adminServices.getStates(this.codeCountry).subscribe(res => {
        for (let i = 0; i < res['data'].length; i++) {
  ...
  edit(address) {
    this.loadingController.create({
      ...
      this.adminServices.editAddressId(this.addressId, address.value).subscribe(res => {
        loading.dismiss();
      ...
      buttons: [
        {
          ...
          handler: () => {
            ...
            this.loadingController.create({
              ...
              this.adminServices.deleteAddress(this.addressId).subscribe(res => {
                loading.dismiss();
                this.toast.show(res['message']);
